                    ...
                    <div class="col-md-12">
                      <article class="mu-blog-single-item">
                        <figure class="mu-blog-single-img">
                          <a href="#"><img alt="img" src="{{asset('user/assets/img/blog/blog-3.jpg')}}"></a>
                      ...
                      <div class="mu-related-item-area">
                        <div id="mu-related-item-slide">
                          <div class="col-md-6">
                            <article class="mu-blog-single-item">
                              <figure class="mu-blog-single-img">
                                <a href="#"><img alt="img" src="{{asset('user/assets/img/blog/blog-1.jpg')}}"></a>
                                <figcaption class="mu-blog-caption">
                                  <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                                </figcaption>                      
                              </figure>
                          ...
                          <div class="col-md-6">
                            <article class="mu-blog-single-item">
                              <figure class="mu-blog-single-img">
                                <a href="#"><img alt="img" src="{{asset('user/assets/img/blog/blog-2.jpg')}}"></a>
                                <figcaption class="mu-blog-caption">
                                  <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                                </figcaption>                      
                              </figure>
                      ...
                      <div class="comments">
                        <ul class="commentlist">
                          <li>
                            <div class="media">
                              <div class="media-left">    
                                <img alt="img" src="{{asset('user/assets/img/testimonial-1.png')}}" class="media-object news-img">
                              </div>
                          ...
                          <li>
                            <div class="media">
                              <div class="media-left">    
                                <img alt="img" src="{{asset('user/assets/img/testimonial-2.png')}}" class="media-object news-img">
                              </div>
                              <div class="media-body">
                          ...
                          <ul class="children">
                            <li class="author-comments">
                              <div class="media">
                                <div class="media-left">    
                                  <img alt="img" src="{{asset('user/assets/img/testimonial-3.png')}}" class="media-object news-img">
                                </div>
                                <div class="media-body">
                  ...
                  <div class="mu-single-sidebar">
                    ...
                    <div class="mu-sidebar-popular-courses">
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img class="media-object" src="{{asset('user/assets/img/courses/1.jpg')}}" alt="img">
                          </a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img class="media-object" src="{{asset('user/assets/img/courses/2.jpg')}}" alt="img">
                          </a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img class="media-object" src="{{asset('user/assets/img/courses/3.jpg')}}" alt="img">
                          </a>
                        </div>
                        <div class="media-body">
